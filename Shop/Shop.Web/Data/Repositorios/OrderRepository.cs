...
namespace Shop.Web.Data.Repositorios
{
    using System;
    using System.Linq;
    ...
    public class OrderRepository : RepositorioGenerico<Order>, IOrderRepository
    {
        ...
        public async Task AddItemToOrderAsync(AddItemViewModel model, string userName)
        {
            ...
            var product = await this.context.productos.FindAsync(model.ProductId);
            if (product == null)
            {
                return;
            }
